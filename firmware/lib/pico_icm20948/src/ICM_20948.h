...
A C++ interface to the ICM-20948 for Raspberry Pi Pico
...
public:
    ...
    void enableDebugging(); //Enable debug messages using printf
...
public:
    ...
    virtual ICM_20948_Status_e begin(i2c_inst_t *i2cPort = i2c_default, uint8_t addr = ICM_20948_I2C_ADDR_AD0);
};
